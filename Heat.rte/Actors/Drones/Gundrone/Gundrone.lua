...
function Create(self)
	...
	-- Sounds
	self.hoverLoop = CreateSoundContainer("Hover Loop Gundrone", "Heat.rte");
	
	self.Accelerate = CreateSoundContainer("Accelerate Gundrone", "Heat.rte");
	
	self.scanLoop = CreateSoundContainer("Scan Loop Gundrone", "Heat.rte");
	self.aggroScanLoop = CreateSoundContainer("Aggro Scan Loop Gundrone", "Heat.rte");
	self.scanLockOn = CreateSoundContainer("Scan Lock On Gundrone", "Heat.rte");
	self.scanLockOff = CreateSoundContainer("Scan Lock Off Gundrone", "Heat.rte");
	
	self.dyingWarningLoop = CreateSoundContainer("Dying Warning Loop Gundrone", "Heat.rte");
